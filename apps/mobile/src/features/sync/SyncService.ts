...
import { createShotId, isDuplicate, deriveStatsSyncPayload } from "@shoot-creater/core";
...
export class SyncService {
	...
	async initPassiveListener(): Promise<void> {
		...
		try {
			const handler = (msg: SyncMessage, reply: ReplyHandler) =>
				this.handleIncoming(msg, reply);
